export const hello = {
  ...
  controller($log) {
    this.tools = [
      ...
      {name: 'ES2015+', href: 'https://devhints.io/es6', image: 'https://cdn-images-1.medium.com/max/785/1*j8TtXep5psnKxDEQeffPfg.png'},
      {name: 'Babel', href: 'https://babeljs.io/', image: 'https://raw.githubusercontent.com/babel/logo/master/babel.png'},
      {name: 'ESLint', href: 'https://eslint.org/', image: 'https://eslint.org/img/logo.svg'},
